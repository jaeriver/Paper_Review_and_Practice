...
- 실시간(online,real-time) ML Inference serving 시스템은 현재
...
- 구성 x = {x1, x2, ... xM) 벡터에 대해 아래의 수식을 가지는 목적함수 f(x)에 대해 모든 구성 중 목적함수 값이 가장큰 구성인 x*를 찾는 것이 목표임
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/74ab7a17-d906-42b9-910e-bd5d477cdf71/Untitled.png)
